...
/**
 * The interface AdaptiveLogger, this implementation learns ideas and some codes from the Netty Project
 *
 * @author ytbean
 * @date 2022/2/25 23:32
 */
public interface AdaptiveLogger {

    /**
     * Return the name of this {@link AdaptiveLogger} instance.
     *
     ...
     * false otherwise.
     */
    boolean isEnabled(AdaptiveLogLevel level);
     ...
     * @param msg the message string to be logged
     */
    void log(AdaptiveLogLevel level, String msg);
     ...
     * @param arg    the argument
     */
    void log(AdaptiveLogLevel level, String format, Object arg);
     ...
     * @param argB   the second argument
     */
    void log(AdaptiveLogLevel level, String format, Object argA, Object argB);
     ...
     * {@link #log(AdaptiveLogLevel, String, Object) one} and
     * {@link #log(AdaptiveLogLevel, String, Object, Object) two} arguments exist solely
     * in order to avoid this hidden cost.</p>
     *
     * @param format    the format string
     * @param arguments a list of 3 or more arguments
     */
    void log(AdaptiveLogLevel level, String format, Object... arguments);
     ...
     * @param t   the exception (throwable) to log
     */
    void log(AdaptiveLogLevel level, String msg, Throwable t);
     ...
     * @param t the exception (throwable) to log
     */
    void log(AdaptiveLogLevel level, Throwable t);
}
